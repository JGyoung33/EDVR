...
def main():
    ...
    if data_mode == 'Vid4':
        ...
        if stage == 1:
            ...
            model_path='../experiments/4k-stage1/models/5500_G.pth'
        else:
    ...
    if data_mode == 'Vid4':
        ...
        GT_dataset_folder = '../datasets/SDR_540p-test/'
    ...
    for subfolder, subfolder_GT in zip(subfolder_l, subfolder_GT_l):
        ...
        for img_idx, img_path in enumerate(img_path_l):
            ...
            img_gu = cv2.GaussianBlur(output,(0,0),3)
            output = cv2.addWeighted(output,1.5,img_gu,-0.5,0)
